...
Aug 2017
Author: pcn 
Python:3.6   birthdeath/viewTransc.py  
Description: display stochastic simulation of birth-death process
             Calls birthdeath/transcrip2rxn.m
             For details see "Physical models of living systems" by Philip Nelson
"""
import numpy as np, matplotlib.pyplot as plt
from scipy.special import factorial as myfactorial
#from SGPniceGraphics import *  # for book
plt.close('all')
myfigsizea = (3, 2.5); myfigsizeb = (2.5,2)
#first example
ks = np.array([.15, .015]) # rate constants in 1/min
runtime= 1600
Nruns=150 # 200 for book fig; 150 for HW
lini = 40
coarse_histo = 1
#second example has much larger populations, same relaxation time constant
...
#%% make book figure g178BDsim. First compare average over many trials
...
#Pfixplot(ax); plt.tight_layout() # for book version
...
#Pfixplot(a2); plt.tight_layout() # for book version
